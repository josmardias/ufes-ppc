...
export default function ProfileNameDialog({
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="flex h-full max-h-none flex-col justify-center gap-4 overflow-y-auto p-4 sm:h-auto sm:max-h-[92vh] sm:justify-start sm:p-6">
